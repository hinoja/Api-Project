        ...
        <div class="owl-banner owl-carousel">
            <div class="banner-item-01">
                <div class="text-content">
                    <h4>Best Offer</h4>
                    <h2>view all best Movies there </h2>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading">
                        <h2>Latest Movies</h2>
                        <a href="products.html"> results({{ $datas['totalResults'] }}) <i
                                class="fa fa-angle-right"></i></a>
                    </div>
                </div>
                @foreach ($datas['Search'] as $data)
                    <div class="col-md-4">
                        <div class="product-item">
                            <a href="#"><img class="display-2" src="{{ $data['Poster'] }}" height="320"
                                    alt="image"></a>
